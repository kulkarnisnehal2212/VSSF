...
export default function Navbar() {
  ...
  const toggle = (name) => setDropdown((prev) => (prev === name ? null : name));
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <div className="flex items-center gap-6 text-sm body-font text-[var(--color-text-primary)]">
              ...
              <Link to="/resources" className="hover:secondary-text transition">Resources</Link>
              <Link to="/projects" className="hover:secondary-text transition">Projects</Link>
              <Link to="/contact" className="hover:secondary-text transition">Contact</Link>
            </div>
          ...
          <div className="md:hidden px-4 sm:px-6 pb-5 pt-2 space-y-1 text-sm body-font bg-white border-t border-gray-100 shadow-lg">
            ...
            <div className="pt-2">
              <Link to="/support" onClick={() => setOpen(false)}>
                <button className="w-full secondary-bg text-white py-3 rounded-xl font-semibold text-sm">Support Us</button>
              </Link>
            </div>
          </div>
        )}
