...
const projects = [
  ...
  },
  {
    ...
    img: hostel,
    imgRight: false,
    highlights: ["Hostel construction completed", "Donation packages available", "Donors can name facilities of their choice"],
    body: "The Kalyanrao Jadhav Boys Hostel in Ahilya Nagar has been successfully completed. Donation packages are available and donors have the opportunity to name facilities of their choice, contributing meaningfully to the infrastructure and future of the students.",
    note: null,
    cta: "Donate Now",
    ctaLink: "/support",
  },
